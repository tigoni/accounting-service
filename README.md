...
2. I dockerized the project. To run and test, clone and run `docker compose up --build`. I have also included a Postmant collection (`AccountingService_Postman_Collection.json`) that can be imported into Postman ready for testing.
